...
struct DisjointSets {
	...
	int getParent(int table) {
		...
		if (sets[table].parent != table) sets[table].parent = getParent(sets[table].parent);
	...
	void merge(int destination, int source) {
		...
		if (realDestination != realSource) {
			int rank_des = sets[realDestination].rank;
			int rank_sou = sets[realSource].rank;
			if(rank_des<rank_sou) {
